...
namespace pno\Request\Tests\Session\Storage;

use pno\Session\Attribute\AttributeBag;
use pno\Session\Flash\FlashBag;
use pno\Session\Storage\Handler\NativeSessionHandler;
use pno\Session\Storage\Handler\NullSessionHandler;
use pno\Session\Storage\NativeSessionStorage;
use pno\Session\Storage\Proxy\SessionHandlerProxy;
...
class NativeSessionStorageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetSaveHandler()
    {
        ...
        $this->assertInstanceOf('pno\Session\Storage\Proxy\SessionHandlerProxy', $storage->getSaveHandler());
