...
namespace pno\Request\Tests\Session;
...
{
    /**
     * @var \pno\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \pno\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('pno\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
}
